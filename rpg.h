...
std::tuple<graph_t*, double> test_on_all_k(graph_t *G, int32_t repeats = 5, bool verbose = false);
std::tuple<graph_t*, double> solver(graph_t *G, int32_t k = 12, int32_t stale = 5, double epsilon = 0.5, double decay = 1.5);